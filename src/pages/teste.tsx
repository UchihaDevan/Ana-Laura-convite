...
import borboletaRosa from '../assets/borboleta-rosa.png'
import borboleta2d from '../assets/borboleta-2d.png'
import {
    CalendarCheck,
    Gift,
    Hourglass,
...
const Teste: React.FC = () => {
    ...
    return (
        <div className="h-[100%] overflow-hidden flex flex-col items-center justify-start relative bg-[#b7dff2]">
            {/* Decorações fixas */}
            <img
                src={passaroTop}
                alt="Borboleta no topo"
                className="absolute left-0 mt-16 w-[60px] animate-float z-10"
            />
            <img
                src={galho}
                alt="Galho"
            ...
            <img
                src={borboleta2d}
                alt="Borboleta 2D"
                className="absolute top-[39%] left-18 transform -translate-x-1/2 -scale-x-100 w-18 z-10"
            />
            <img
                src={borboletaRosa}
                alt="Borboleta Rosa"
                className="absolute bottom-20 left-[40%] w-18 sm:w-16 animate-float-slow z-0"
            />
            <img
                src={casaPassaro}
                alt="Casa de pássaro"
            ...
            <img
                ...
                className="absolute right-0 top-[50%] w-16 sm:w-20 animate-float z-10"
            />
            <img
                src={borboletaLocal}
                alt="Borboleta botão"
